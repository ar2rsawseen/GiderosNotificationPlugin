...
public:
	...
	void onLocalNotification(jint id, jstring jtitle, jstring jtext, jint number, jstring jsound)
	{
		JNIEnv *env = g_getJNIEnv();
	...
	void onPushNotification(jint id, jstring jtitle, jstring jtext, jint number, jstring jsound)
	{
		JNIEnv *env = g_getJNIEnv();
		const char *title = env->GetStringUTFChars(jtitle, NULL);
		const char *text = env->GetStringUTFChars(jtext, NULL);
...
extern "C" {
	...
	void Java_com_giderosmobile_android_plugins_notification_NotificationClass_onLocalNotification(JNIEnv *env, jclass clz, jint id, jstring jtitle, jstring jtext, jint number, jstring jsound, jlong data)
	{
		((GNotification*)data)->onLocalNotification(id, jtitle, jtext, number, jsound);
	}
	
	void Java_com_giderosmobile_android_plugins_notification_NotificationClass_onPushNotification(JNIEnv *env, jclass clz, jint id, jstring jtitle, jstring jtext, jint number, jstring jsound, jlong data)
	{
		((GNotification*)data)->onPushNotification(id, jtitle, jtext, number, jsound);
	}
