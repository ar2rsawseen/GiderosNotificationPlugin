...
mngr:addEventListener(Event.ON_LOCAL_NOTIFICATION, function(e)
...
mngr:addEventListener(Event.ON_PUSH_REGISTRATION, function(e)
	print("Push notification registered: "..e.deviceId)
end)

mngr:addEventListener(Event.ON_PUSH_REGISTRATION_ERROR, function(e)
	print("Could not register: "..e.error)
end)

mngr:addEventListener(Event.ON_PUSH_NOTIFICATION, function(e)
